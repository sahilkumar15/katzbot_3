...
class KatzBotConfig:
    ...
    def setup_file_paths(self):
        ...
        self.DATA_FILE = os.path.join(self.BASE_DIR, r'data/loaded_dataset_website.pkl')
        self.CHAT_HISTORY_FILE = os.path.join(self.BASE_DIR, r'session_chat_history.csv')
